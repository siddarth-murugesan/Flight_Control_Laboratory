...
// Initial value for the new added states F and R
static float initialF = 0.0;
// It does not matter since it is overwritten on the first range up measurement (as long as stateRInitialized is set to false)
static float initialR = -1.0;
...
//  this->S[KC_STATE_D2] = 0;
  ...
  // This is set to false so that the first range up measurement will overwrite the set initial value 
