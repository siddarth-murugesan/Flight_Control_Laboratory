...
// Added Multiranger measurement - MeasurementTypeUpTOF into kalman
typedef enum {
  MeasurementTypeTDOA,
...
// Flow deck (z ranger) measurement enqueue procedure used in kalman
...
// Added Multiranger measurement enqueue procedure to use in kalman
